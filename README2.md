...
생성된 답변은 영어 원문으로 제공되며, 사용자는 **한국어 번역보기** 기능을 통해 번역된 답변을 확인할 수 있다. 번역된 답변에서는 **원문보기** 기능을 통해 다시 영어 원문으로 전환할 수 있다. 또한 대화형 인터페이스를 통해 이전 대화 내용을 기반으로 연속적인 질의응답을 지원한다.

* **입력:** 사용자 의료 질문
* **처리:** 질문 재구성 및 의료 지식·임상 진료지침 검색
* **답변 생성:** Graph Context + Guideline Context 기반 AI 답변 생성
* **출력:** 영어 원문 답변
* **번역:** 한국어 번역보기 / 원문보기 기능을 통한 답변 언어 전환
* **대화:** 이전 대화 내용을 기반으로 한 연속 질의응답 지원

![MedicalQA 답변 근거 화면](./docs/images/answer_screen2.png)

답변 하단에는 해당 답변을 생성하는 데 활용된 **임상 진료지침과 의료 개념의 개수**를 표시하고, **근거보기** 버튼을 제공한다. 사용자가 근거보기를 선택하면 답변 생성에 활용된 **임상 진료지침과 의료 지식 그래프 기반 근거 정보**를 상세하게 확인할 수 있다.
